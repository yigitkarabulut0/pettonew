...
export default function AppLayout() {
  ...
  return (
    <Stack screenOptions={{ animation: "slide_from_right" }}>
      ...
      <Stack.Screen name="health-profile/[petId]" options={{ headerShown: false }} />
      <Stack.Screen name="symptom-log/[petId]" options={{ headerShown: false }} />
      <Stack.Screen name="medications/[petId]" options={{ headerShown: false }} />
      <Stack.Screen name="documents/[petId]" options={{ headerShown: false }} />
      <Stack.Screen name="calories/[petId]" options={{ headerShown: false }} />
      <Stack.Screen name="breed-care/[petId]" options={{ headerShown: false }} />
